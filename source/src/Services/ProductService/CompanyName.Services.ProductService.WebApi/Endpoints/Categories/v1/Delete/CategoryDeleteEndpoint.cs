...
using CompanyName.Services.ProductService.Application.Categories.v1.Commands.Delete;

namespace CompanyName.Services.ProductService.WebApi.Endpoints.Categories.v1.Delete;
