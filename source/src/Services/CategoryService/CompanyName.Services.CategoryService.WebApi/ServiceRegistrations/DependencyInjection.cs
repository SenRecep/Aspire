...
using CompanyName.Services.CategoryService.Application.ServiceRegistrations;
using CompanyName.Services.CategoryService.Persistence.ServiceRegistrations;
